...
|-----------------------------------------------------|---------------------------|
| Java의 정석                                           | 남궁성                |
| Lets 실전예제로 배우는 자바 프로그래밍 (Java Programming) | 서민구                |
| Lets 실전예제로 배우는 HTML5 & CSS3                     | 문선종                |
| 그림으로 이해하는 AWS 구조와 기술                      | 오가사와라 시게타카(글) · 성창규 번역 |
| 바닐라 자바스크립트                                      | 고승원                |
| 리액트를 다루는 기술                                    | 김민준                |
...
| 책 제목                                                      | 저자                |
|-------------------------------------------------------------|--------------------|
| 스프링 부트 3 백엔드 개발자 되기 - 자바 편 JPA + OAuth2 + JWT + AWS와 배우는 스프링 부트 3 | 신선영         |
| 현장에서 바로 써먹는 리액트 with 타입스크립트                   | 김정헌         |
